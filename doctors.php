            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Doctores</h3>
        	...
        	<div class="card">
        			...
        			<div class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								...
								?>
								<h2><b>Doctor/es que están en <?php echo $s ?></b></h2>
							</div>
						</div>
						<hr class="divider">
						<?php endif; ?>
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 ...
						 <p><small>Direccion de la clinica / Sala : <b><?php echo $row['clinic_address'] ?></b></small></p>
					...
					<div class="col-md-3 text-center align-self-end-sm">
						<button class="btn-outline-primary  btn  mb-4 set_appointment" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo "Dr. ".$row['name'].', '.$row['name_pref'] ?>">Establecer Turno</button>
					</div>
				</div>

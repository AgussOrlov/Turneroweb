			...
			<form action="" id="manage-doctor">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Especialidades Medicas</label>
							...
							<div class="form-group">
								<label class="control-label">Direccion de Clinica / Sala</label>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 ...
										 <p><small>Direccion de Clinica / Sala: <b><?php echo $row['clinic_address'] ?></b></small></p>
										 <p><small>Contacto (Tel): <b><?php echo $row['contact'] ?></b></small></p>

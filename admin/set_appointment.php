	...
	<div class="col-lg-12">
		...
		<form action="" id="manage-appointment">
			...
			<div class="form-group">
				<label for="" class="control-label">Doctores</label>
		...
		<?php endif; ?>
			<div class="form-group">
				<label for="" class="control-label">Pacientes</label>
			...
			<div class="form-group">
				...
				<select class="browser-default custom-select" name="status">
					<option value="0" <?php echo isset($status) && $status == 0 ? "selected" : '' ; ?>>Solicitado</option>
	...
	$("#manage-appointment").submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				...
				if(resp.status == 1){
					alert_toast("Solicitud Enviada con Exito");
					// end_load();
					$('.modal').modal("hide");
					setTimeout(function(){
						location.reload();

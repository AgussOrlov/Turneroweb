            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                        ...
                        <a class="btn btn-primary btn-xl js-scroll-trigger" href="index.php?page=doctors">Ver Doctores</a>
    ...
    <div id="portfolio" class="container">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="index.php?page=doctors&sid=<?php echo $row['id'] ?>">
                            ...
                            <div class="portfolio-box-caption">
                                ...
                                <div class="project-category text-white">Ver Doctores</div>
                            </div>
                        </a>
        ...
        <div id="portfolio" class="container">
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-lg-12 text-center">
                    <h2 class="mb-4">Obras Sociales</h2>
                    <hr class="divider">
                ...
                <div class="row no-gutters">
                    ...
                    ?>
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="index.php?page=doctors&sid=<?php echo $row['iddos'] ?>">
                            <img class="img-fluid" src="assets/img/<?php echo $row['img_pathdos'] ?>" alt="" />
                            <div class="portfolio-box-caption">
                                <div class="project-name"><?php echo $row['namedos'] ?></div>
                                <div class="project-category text-white">Ver Doctores</div>
                            </div>
                        </a>
